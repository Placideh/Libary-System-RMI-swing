 ...
 * @author placideh
 */
public class AcountCreate extends javax.swing.JFrame {

    /**
     * Creates new form AcountCreate
     */
    public AcountCreate() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("LIBRARY SYSTEM ACCOUNT CREATION");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            loginService.createAcount(login);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AcountCreate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AcountCreate().setVisible(true);
            }
        });
    }
